    ...
    renderClassScreen: (course, students) => {
        ...
        const studentList = students.map((s, index) => {
            ...
            const avatarImg = avatarSrc 
                ? `<img src="${avatarSrc}" class="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-gray-200 cursor-pointer view-avatar-btn hover:opacity-80 transition" data-src="${avatarSrc}" data-name="${s.Name}" alt="${s.Name}">` 
